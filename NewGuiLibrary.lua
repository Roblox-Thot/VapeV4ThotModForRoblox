if shared.VapeExecuted then
	...
	local customdir = (shared.VapePrivate and "vapeprivate/" or "vapeModded/")
	...
	local api = {
		...
		["RainbowSpeed"] = 0.6,
		["Language"] = betterisfile("vapeModded/language.dat") and readfile("vapeModded/language.dat") or "en-us",
	...
	searchbaricon.Image = getcustomassetfunc("vapeModded/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = getcustomassetfunc("vapeModded/assets/WindowBlur.png")
	...
	hoverboxshadow.Image = getcustomassetfunc("vapeModded/assets/WindowBlur.png")
	...
	api["LoadSettings"] = function(customprofile)
		...
		if betterisfile("vapeModded/Profiles/GUIPositions.vapeprofile.txt") and game.GameId == 2619619496 then
			writefile("vapeModded/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("vapeModded/Profiles/GUIPositions.vapeprofile.txt"))
			if delfile then delfile("vapeModded/Profiles/GUIPositions.vapeprofile.txt") end
		end
		if shared.VapePrivate then
			if betterisfile("vapeprivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") == false and betterisfile("vapeModded/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") then
				writefile("vapeprivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("vapeModded/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt"))
			end
			if betterisfile("vapeprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") == false and betterisfile("vapeModded/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") then
				writefile("vapeprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt", readfile("vapeModded/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt"))
			end
			if betterisfile("vapeprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") == false and betterisfile("vapeModded/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") then
				writefile("vapeprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt", readfile("vapeModded/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt"))
			end
		end
	...
	api["CreateMainWindow"] = function()
		...
		windowshadow.Image = getcustomassetfunc("vapeModded/assets/WindowBlur.png")
		...
		windowlogo1.Image = getcustomassetfunc(translatedlogo and "vapeModded/translations/"..api["Language"].."/VapeLogo1.png" or "vapeModded/assets/VapeLogo1.png")
		...
		windowlogo2.Image = getcustomassetfunc("vapeModded/assets/VapeLogo2.png")
		...
		settingswheel.Image = getcustomassetfunc("vapeModded/assets/SettingsWheel1.png")
		...
		discordbutton.Image = getcustomassetfunc("vapeModded/assets/DiscordIcon.png")
		...
		settingsexit.Image = getcustomassetfunc("vapeModded/assets/ExitIcon1.png")
		...
		overlaysicon.Image = getcustomassetfunc("vapeModded/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = getcustomassetfunc("vapeModded/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = getcustomassetfunc("vapeModded/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = getcustomassetfunc("vapeModded/assets/BackIcon.png")
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = getcustomassetfunc("vapeModded/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = getcustomassetfunc("vapeModded/assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = getcustomassetfunc("vapeModded/assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = getcustomassetfunc("vapeModded/assets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindimg.Image = getcustomassetfunc("vapeModded/assets/KeybindIcon.png")
			...
			bindtext2.Image = getcustomassetfunc("vapeModded/assets/BindBackground.png")
			...
			bindbkg.MouseEnter:connect(function() 
				bindimg.Image = getcustomassetfunc("vapeModded/assets/PencilIcon.png") 
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = getcustomassetfunc("vapeModded/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = getcustomassetfunc("vapeModded/assets/ColorSlider1.png")
			...
			sliderapi["SetValue"] = function(val)
				slider3.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("vapeModded/assets/ColorSlider2.png") or getcustomassetfunc("vapeModded/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("vapeModded/assets/RainbowIcon2.png") or getcustomassetfunc("vapeModded/assets/RainbowIcon1.png"))
	...
	api["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = getcustomassetfunc("vapeModded/assets/PinButton.png")
		...
		optionsbutton.Image = getcustomassetfunc("vapeModded/assets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = getcustomassetfunc("vapeModded/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = getcustomassetfunc("vapeModded/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = getcustomassetfunc((argstable["Name"] == "ProfilesList" and "vapeModded/assets/TextBoxBKG2.png" or "vapeModded/assets/TextBoxBKG.png"))
				...
				addbutton.Image = getcustomassetfunc("vapeModded/assets/AddItem.png")
				...
				textapi["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textapi["ObjectList"]) do
						...
						deletebutton.Image = getcustomassetfunc("vapeModded/assets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = getcustomassetfunc("vapeModded/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = getcustomassetfunc("vapeModded/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	api["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = getcustomassetfunc("vapeModded/assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = getcustomassetfunc("vapeModded/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = getcustomassetfunc("vapeModded/assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = getcustomassetfunc("vapeModded/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = getcustomassetfunc("vapeModded/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["Players"] = windowapi["CreateButton"]({
					...
					["Icon"] = "vapeModded/assets/TargetIcon1.png",
					["IconSize"] = 15,
				...
				buttonreturned["NPCs"] = windowapi["CreateButton"]({
					...
					["Icon"] = "vapeModded/assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowapi["CreateButton"]({
					...
					["Icon"] = "vapeModded/assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = "vapeModded/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonapi["CreateColorSlider"] = function(argstable)
				...
				sliderexpand.Image = getcustomassetfunc("vapeModded/assets/HoverArrow3.png")
				sliderexpand.Parent = frame
				sliderexpand.MouseEnter:connect(function()
					sliderexpand.Image = getcustomassetfunc("vapeModded/assets/HoverArrow4.png")
				end)
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = getcustomassetfunc("vapeModded/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = getcustomassetfunc("vapeModded/assets/SliderArrow1.png")
	...
	api["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = getcustomassetfunc("vapeModded/assets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, game:GetService("TextService"):GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = getcustomassetfunc("vapeModded/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:connect(function()
				sliderexpand.Image = getcustomassetfunc("vapeModded/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:connect(function()
				sliderexpand.Image = getcustomassetfunc("vapeModded/assets/HoverArrow.png")
			end)
	...
	api["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = getcustomassetfunc("vapeModded/assets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = getcustomassetfunc("vapeModded/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = getcustomassetfunc(customicon and "vapeModded/"..customicon or "vapeModded/assets/InfoNotification.png")
