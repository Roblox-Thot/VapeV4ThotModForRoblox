...
local function checkassetversion()
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/Roblox-Thot/VapeV4ThotModForRoblox/main/assetsversion.dat",
		Method = "GET"
	})
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/Roblox-Thot/VapeV4ThotModForRoblox/main/CustomModules/"..id..".vape",
		Method = "GET"
	}) end)
	if not suc then
...
OnlineProfilesButton.MouseButton1Click:connect(function()
	...
	if profilesloaded == false then
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode((shared.VapeDeveloper and readfile("vapeModded/OnlineProfiles.vapeonline") or game:HttpGet("https://raw.githubusercontent.com/Roblox-Thot/VapeV4ThotModForRoblox/main/OnlineProfiles.vapeonline", true)))
		end)
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started and not shared.VapeIndependent then
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("vapeModded/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/Roblox-Thot/VapeV4ThotModForRoblox/main/NewMainScript.lua", true))() end'
		if shared.VapeDeveloper then
