...
local function checkassetversion()
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/Roblox-Thot/VapeV4ForRoblox/main//assetsversion.dat",
		Method = "GET"
	})
...
if not betterisfile("vapeModded/language.dat") then
	local suc, res = pcall(function() return gethiddenproperty(game:GetService("Players").LocalPlayer, "ReplicatedLocaleId") end)
	writefile("vapeModded/language.dat", suc and res or "en-us")
end
if not pcall(function() return GetURL("translations/"..readfile("vapeModded/language.dat")..".vapetranslation") end) then
	writefile("vapeModded/language.dat", "en-us")
end
local assetver = checkassetversion()
if assetver and assetver > readfile("vapeModded/assetsversion.dat") then
	if shared.VapeDeveloper == nil then
		if isfolder("vapeModded/assets") then
			if delfolder then
				delfolder("vapeModded/assets")
			end
		end
		writefile("vapeModded/assetsversion.dat", assetver)
	end
end
if isfolder("vapeModded/assets") == false then
	makefolder("vapeModded/assets")
end
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/Roblox-Thot/VapeV4ForRoblox/main//CustomModules/"..id..".vape",
		Method = "GET"
	}) end)
	if not suc then
...
local Combat = GuiLibrary.CreateWindow({
	["Name"] = "Combat", 
	["Icon"] = "vapeModded/assets/CombatIcon.png", 
	["IconSize"] = 15
})
local Blatant = GuiLibrary.CreateWindow({
	["Name"] = "Blatant", 
	["Icon"] = "vapeModded/assets/BlatantIcon.png", 
	["IconSize"] = 16
})
local Render = GuiLibrary.CreateWindow({
	["Name"] = "Render", 
	["Icon"] = "vapeModded/assets/RenderIcon.png", 
	["IconSize"] = 17
})
local Utility = GuiLibrary.CreateWindow({
	["Name"] = "Utility", 
	["Icon"] = "vapeModded/assets/UtilityIcon.png", 
	["IconSize"] = 17
})
local World = GuiLibrary.CreateWindow({
	["Name"] = "World", 
	["Icon"] = "vapeModded/assets/WorldIcon.png", 
	["IconSize"] = 16
})
local Friends = GuiLibrary.CreateWindow2({
	["Name"] = "Friends", 
	["Icon"] = "vapeModded/assets/FriendsIcon.png", 
	["IconSize"] = 17
})
local Profiles = GuiLibrary.CreateWindow2({
	["Name"] = "Profiles", 
	["Icon"] = "vapeModded/assets/ProfilesIcon.png", 
	["IconSize"] = 19
})
GUI.CreateDivider()
GUI.CreateButton({
...
OnlineProfilesButtonImage.Image = getcustomassetfunc("vapeModded/assets/OnlineProfilesButton.png")
...
OnlineProfilesExitButton.Image = getcustomassetfunc("vapeModded/assets/ExitIcon1.png")
...
OnlineProfilesFrameShadow.Image = getcustomassetfunc("vapeModded/assets/WindowBlur.png")
...
OnlineProfilesFrameIcon.Image = getcustomassetfunc("vapeModded/assets/ProfilesIcon.png")
...
OnlineProfilesButton.MouseButton1Click:connect(function()
	...
	if profilesloaded == false then
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode((shared.VapeDeveloper and readfile("vapeModded/OnlineProfiles.vapeonline") or game:HttpGet("https://raw.githubusercontent.com/Roblox-Thot/VapeV4ForRoblox/main//OnlineProfiles.vapeonline", true)))
		end)
		...
		for i2,v2 in pairs(onlineprofiles) do
			if tostring(v2["ProfileGame"]) == tostring(shared.CustomSaveVape or game.PlaceId) then
				...
				profiledownload.MouseButton1Click:connect(function()
					writefile(customdir.."Profiles/"..v2["ProfileName"]..tostring(game.PlaceId)..".vapeprofile.txt", (shared.VapeDeveloper and readfile("vapeModded/OnlineProfiles/"..v2["OnlineProfileName"]) or game:HttpGet("https://raw.githubusercontent.com/Roblox-Thot/VapeV4ForRoblox/main//OnlineProfiles/"..v2["OnlineProfileName"], true)))
...
GUI.CreateDivider()
---GUI.CreateCustomButton("Favorites", "vapeModded/assets/FavoritesListIcon.png", UDim2.new(0, 17, 0, 14), function() end, function() end)
--GUI.CreateCustomButton("Text GUIVertical", "vapeModded/assets/TextGUIIcon3.png", UDim2.new(1, -56, 0, 15), function() end, function() end)
local TextGui = GuiLibrary.CreateCustomWindow({
	["Name"] = "Text GUI", 
	["Icon"] = "vapeModded/assets/TextGUIIcon1.png", 
	["IconSize"] = 21
})
local TextGuiCircleObject = {["CircleList"] = {}}
--GUI.CreateCustomButton("Text GUI", "vapeModded/assets/TextGUIIcon2.png", UDim2.new(1, -23, 0, 15), function() TextGui.SetVisible(true) end, function() TextGui.SetVisible(false) end, "OptionsButton")
GUI.CreateCustomToggle({
	["Name"] = "Text GUI", 
	["Icon"] = "vapeModded/assets/TextGUIIcon3.png",
...
onething.Image = getcustomassetfunc(translatedlogo and "vapeModded/translations/"..GuiLibrary["Language"].."/VapeLogo3.png" or "vapeModded/assets/VapeLogo3.png")
...
onething2.Image = getcustomassetfunc("vapeModded/assets/VapeLogo4.png")
...
local TargetInfo = GuiLibrary.CreateCustomWindow({
	["Name"] = "Target Info",
	["Icon"] = "vapeModded/assets/TargetInfoIcon1.png",
	["IconSize"] = 16
})
...
GUI.CreateCustomToggle({
	["Name"] = "Target Info", 
	["Icon"] = "vapeModded/assets/TargetInfoIcon2.png", 
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started and not shared.VapeIndependent then
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("vapeModded/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/Roblox-Thot/VapeV4ForRoblox/main//NewMainScript.lua", true))() end'
		if shared.VapeDeveloper then
